...
function layout(title, body){
  const css = `
:root{--bgA:#070b1a;--bgB:#111827;--glass:#ffffffd9;--glass2:#ffffff1f;--text:#0f172a;--muted:#64748b;--primary:#7c3aed;--cyan:#06b6d4;--pink:#ec4899;--green:#22c55e;--danger:#ef4444;--warning:#f59e0b;--border:#e2e8f0;--shadow:0 22px 60px #02061740;--r:24px}*{box-sizing:border-box}html{min-height:100%;scroll-behavior:smooth}body{margin:0;font-family:Tahoma,Arial,sans-serif;color:var(--text);direction:rtl;min-height:100vh;background:radial-gradient(circle at 80% 10%,#312e81 0,#111827 32%,#020617 100%);overflow-x:hidden}.ai-bg{position:fixed;inset:0;z-index:-3;overflow:hidden}.orb{position:absolute;width:42vw;max-width:520px;height:42vw;max-height:520px;border-radius:50%;filter:blur(22px);opacity:.22;animation:orb 24s ease-in-out infinite}.orb.a{background:#06b6d4;right:-10%;top:-10%}.orb.b{background:#8b5cf6;left:-12%;bottom:-12%;animation-delay:-5s}.orb.c{background:#ec4899;right:25%;bottom:12%;animation-delay:-9s}.grid-bg{position:fixed;inset:0;z-index:-2;background-image:linear-gradient(#ffffff12 1px,transparent 1px),linear-gradient(90deg,#ffffff12 1px,transparent 1px);background-size:44px 44px;mask-image:linear-gradient(to bottom,#000,transparent 75%);}@keyframes gridmove{to{transform:translateY(44px)}}@keyframes orb{0%,100%{transform:translate3d(0,0,0) scale(1)}50%{transform:translate3d(55px,35px,0) scale(1.16)}}.container{max-width:1120px;margin:auto;padding:22px 16px 92px}.card{position:relative;background:var(--glass);border:1px solid #ffffffb3;border-radius:var(--r);padding:22px;margin:18px 0;box-shadow:var(--shadow);animation:rise .18s ease both;overflow:hidden}.card:before{content:"";position:absolute;inset:0 0 auto 0;height:4px;background:linear-gradient(90deg,var(--cyan),var(--primary),var(--pink));opacity:.9}.card:hover{transform:translateY(-4px);box-shadow:0 14px 34px #02061733}.btn:active,.nav a:active{transform:scale(.96)}@keyframes rise{from{opacity:0;transform:translateY(18px) scale(.98)}to{opacity:1;transform:translateY(0) scale(1)}}h1{font-size:clamp(28px,6vw,48px);line-height:1.15;margin:12px 0 20px;color:#fff;text-shadow:0 12px 35px #0008}h2,h3{margin-top:0}.card h1,.card h2,.card h3{color:#111827;text-shadow:none}.muted{color:var(--muted)}a{color:#2563eb;text-decoration:none;font-weight:800}.nav{position:sticky;top:8px;z-index:20;display:flex;gap:10px;flex-wrap:wrap;margin:0 0 16px;background:#ffffff22;border:1px solid #ffffff55;border-radius:22px;padding:10px;box-shadow:0 12px 30px #0002}.nav a,.btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;background:linear-gradient(135deg,var(--primary),var(--cyan));color:#fff;border:none;border-radius:16px;padding:12px 16px;cursor:pointer;font-size:15px;font-weight:900;box-shadow:0 12px 26px #0002;transition:.12s;min-height:46px}.nav a:hover,.btn:hover{transform:translateY(-3px);filter:saturate(1.18)}.btn.secondary{background:linear-gradient(135deg,#334155,#64748b)}.btn.danger{background:linear-gradient(135deg,#dc2626,#fb7185)}.btn.ok{background:linear-gradient(135deg,#16a34a,#22c55e)}.ico{width:20px;height:20px;display:inline-flex;align-items:center;justify-content:center;flex:0 0 20px}.ico svg{width:20px;height:20px;fill:currentColor;}@keyframes iconPulse{0%,100%{transform:scale(1)}50%{transform:scale(1.12) rotate(-2deg)}}input,textarea,select{width:100%;padding:14px;border:1px solid var(--border);border-radius:16px;margin:7px 0 15px;font-size:16px;background:#fff;outline:none;transition:.12s;min-height:48px}input:focus,textarea:focus,select:focus{border-color:var(--primary);box-shadow:0 0 0 5px #7c3aed22}textarea{min-height:110px;resize:vertical}label{font-weight:900}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px}.row{display:flex;gap:10px;align-items:center;flex-wrap:wrap}.option{display:flex;gap:10px;align-items:center;padding:12px;border:1px solid #e5e7eb;border-radius:16px;margin:9px 0;background:#f8fafc;transition:.12s;cursor:pointer}.option:hover{background:#eef2ff;transform:translateX(-2px)}.option input[type=radio]{width:auto;margin:0;min-height:auto}.table{width:100%;border-collapse:separate;border-spacing:0 9px;overflow:auto}.table th{color:#475569}.table th,.table td{padding:12px;text-align:right;vertical-align:middle}.table tr{background:#f8fafc}.table td:first-child,.table th:first-child{border-radius:0 16px 16px 0}.table td:last-child,.table th:last-child{border-radius:16px 0 0 16px}.badge{display:inline-flex;align-items:center;gap:6px;background:#ede9fe;color:#6d28d9;border-radius:999px;padding:6px 12px;font-size:13px;font-weight:900}.notice{padding:14px;border-radius:16px;background:#ecfeff;border:1px solid #a5f3fc}.error{padding:14px;border-radius:16px;background:#fef2f2;border:1px solid #fecaca;color:#991b1b}.ltr{direction:ltr;text-align:left}.small{font-size:13px}.question{border-top:1px solid var(--border);padding-top:16px;margin-top:16px}.linkbox{background:#eef2ff;border:1px dashed #818cf8;border-radius:18px;padding:14px;word-break:break-all;line-height:1.7}.ai-panel{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:12px}.ai-tip{background:linear-gradient(135deg,#fff,#eff6ff);border:1px solid #dbeafe;border-radius:18px;padding:14px;font-weight:800}.footer{margin:28px auto 8px;text-align:center;color:#fff;font-size:15px;font-weight:900;border:1px solid #ffffff66;background:linear-gradient(135deg,#ffffff22,#ffffff0f);border-radius:22px;padding:13px 20px;max-width:390px;box-shadow:0 18px 45px #0005;animation:rise .18s ease both}.footer b{color:#67e8f9}.shine{position:relative;overflow:hidden}.shine:after{content:'';position:absolute;inset:-80% auto auto -30%;width:35%;height:260%;background:linear-gradient(90deg,transparent,#fff8,transparent);transform:rotate(25deg);}@keyframes shine{0%,55%{left:-40%}100%{left:120%}}.toast{position:fixed;left:50%;bottom:22px;transform:translateX(-50%);background:#111827;color:#fff;padding:12px 18px;border-radius:999px;box-shadow:var(--shadow);z-index:80;display:none}.bottom-nav{display:none}@media(max-width:720px){.container{padding:12px 10px 98px}.card{padding:16px;border-radius:20px;margin:14px 0}.nav{display:none}.bottom-nav{position:fixed;bottom:10px;left:10px;right:10px;z-index:60;display:grid;grid-template-columns:repeat(4,1fr);gap:8px;background:#0f172acc;border:1px solid #ffffff38;border-radius:22px;padding:9px;box-shadow:0 16px 40px #0006}.bottom-nav a{display:flex;flex-direction:column;align-items:center;gap:4px;color:#fff;text-decoration:none;font-size:11px;font-weight:900}.bottom-nav .ico{width:22px;height:22px}.row,.row form{width:100%}.row .btn,.row a.btn,.row form button{width:100%}.table{display:block;overflow-x:auto;white-space:nowrap}input,textarea,select{font-size:16px}.btn{width:100%}}
`;
  const js = `<script>function showLoading(t){var e=document.getElementById('toast');if(e){e.textContent=t||'جاري التحميل...';e.style.display='block'}}document.addEventListener('submit',function(e){var b=e.target.querySelector('button');if(b){b.disabled=true;b.dataset.old=b.textContent;b.textContent='جاري التنفيذ...'}showLoading('جاري التنفيذ...')});document.addEventListener('click',function(e){var a=e.target.closest('a');if(a&&a.href&&!a.target&&a.getAttribute('href')!=='#')showLoading('جاري فتح الصفحة...')});function copyLink(t){navigator.clipboard&&navigator.clipboard.writeText(t).then(function(){toast('تم نسخ رابط الامتحان')}).catch(function(){prompt('انسخ الرابط',t)})}function toast(t){var e=document.getElementById('toast');if(!e)return;e.textContent=t;e.style.display='block';setTimeout(function(){e.style.display='none'},1500)}function go(url){showLoading();location.href=url}</script>`;
