...
`;
  const js = `<script>function copyLink(t){navigator.clipboard&&navigator.clipboard.writeText(t).then(function(){toast('تم نسخ رابط الامتحان')}).catch(function(){prompt('انسخ الرابط',t)})}function toast(t){var e=document.getElementById('toast');if(!e)return;e.textContent=t;e.style.display='block';setTimeout(function(){e.style.display='none'},1200)}function go(url){location.href=url}</script>`;
